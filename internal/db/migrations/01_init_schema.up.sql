...
ALTER TABLE "seller_profiles" ADD FOREIGN KEY ("seller_id") REFERENCES "users" ("id") ON DELETE CASCADE;

ALTER TABLE "user_addresses" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("id");

ALTER TABLE "gundams" ADD FOREIGN KEY ("owner_id") REFERENCES "users" ("id");

ALTER TABLE "gundams" ADD FOREIGN KEY ("grade_id") REFERENCES "gundam_grades" ("id");

ALTER TABLE "gundam_accessories" ADD FOREIGN KEY ("gundam_id") REFERENCES "gundams" ("id") ON DELETE CASCADE;

ALTER TABLE "gundam_images" ADD FOREIGN KEY ("gundam_id") REFERENCES "gundams" ("id") ON DELETE CASCADE;
...
ALTER TABLE "cart_items" ADD FOREIGN KEY ("gundam_id") REFERENCES "gundams" ("id") ON DELETE CASCADE;

ALTER TABLE "seller_subscriptions" ADD FOREIGN KEY ("plan_id") REFERENCES "subscription_plans" ("id");

ALTER TABLE "seller_subscriptions" ADD FOREIGN KEY ("seller_id") REFERENCES "users" ("id") ON DELETE CASCADE;

ALTER TABLE "orders" ADD FOREIGN KEY ("buyer_id") REFERENCES "users" ("id");

ALTER TABLE "orders" ADD FOREIGN KEY ("seller_id") REFERENCES "users" ("id");

ALTER TABLE "orders" ADD FOREIGN KEY ("canceled_by") REFERENCES "users" ("id") ON DELETE SET NULL;

ALTER TABLE "order_items" ADD FOREIGN KEY ("order_id") REFERENCES "orders" ("id") ON DELETE CASCADE;

ALTER TABLE "order_items" ADD FOREIGN KEY ("gundam_id") REFERENCES "gundams" ("id") ON DELETE SET NULL;

ALTER TABLE "delivery_information" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON DELETE CASCADE;

ALTER TABLE "order_deliveries" ADD FOREIGN KEY ("from_delivery_id") REFERENCES "delivery_information" ("id");

ALTER TABLE "order_deliveries" ADD FOREIGN KEY ("to_delivery_id") REFERENCES "delivery_information" ("id");

ALTER TABLE "order_deliveries" ADD FOREIGN KEY ("order_id") REFERENCES "orders" ("id") ON DELETE CASCADE;

ALTER TABLE "wallets" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON DELETE CASCADE;

ALTER TABLE "wallet_entries" ADD FOREIGN KEY ("wallet_id") REFERENCES "wallets" ("user_id") ON DELETE CASCADE;

ALTER TABLE "order_transactions" ADD FOREIGN KEY ("buyer_entry_id") REFERENCES "wallet_entries" ("id");

ALTER TABLE "order_transactions" ADD FOREIGN KEY ("seller_entry_id") REFERENCES "wallet_entries" ("id");

ALTER TABLE "order_transactions" ADD FOREIGN KEY ("order_id") REFERENCES "orders" ("id") ON DELETE CASCADE;

ALTER TABLE "payment_transactions" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("id");

ALTER TABLE "exchange_posts" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON DELETE CASCADE;

ALTER TABLE "exchange_post_items" ADD FOREIGN KEY ("gundam_id") REFERENCES "gundams" ("id");

ALTER TABLE "exchange_post_items" ADD FOREIGN KEY ("post_id") REFERENCES "exchange_posts" ("id") ON DELETE CASCADE;

ALTER TABLE "exchange_offers" ADD FOREIGN KEY ("post_id") REFERENCES "exchange_posts" ("id") ON DELETE CASCADE;

ALTER TABLE "exchange_offers" ADD FOREIGN KEY ("offerer_id") REFERENCES "users" ("id") ON DELETE CASCADE;

ALTER TABLE "exchange_offers" ADD FOREIGN KEY ("payer_id") REFERENCES "users" ("id") ON DELETE CASCADE;

ALTER TABLE "exchange_offer_notes" ADD FOREIGN KEY ("offer_id") REFERENCES "exchange_offers" ("id") ON DELETE CASCADE;

ALTER TABLE "exchange_offer_notes" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON DELETE CASCADE;

ALTER TABLE "exchange_offer_items" ADD FOREIGN KEY ("gundam_id") REFERENCES "gundams" ("id");

ALTER TABLE "exchange_offer_items" ADD FOREIGN KEY ("offer_id") REFERENCES "exchange_offers" ("id") ON DELETE CASCADE;

ALTER TABLE "exchanges" ADD FOREIGN KEY ("poster_from_delivery_id") REFERENCES "delivery_information" ("id");

ALTER TABLE "exchanges" ADD FOREIGN KEY ("poster_to_delivery_id") REFERENCES "delivery_information" ("id");

ALTER TABLE "exchanges" ADD FOREIGN KEY ("offerer_from_delivery_id") REFERENCES "delivery_information" ("id");

ALTER TABLE "exchanges" ADD FOREIGN KEY ("offerer_to_delivery_id") REFERENCES "delivery_information" ("id");

ALTER TABLE "exchanges" ADD FOREIGN KEY ("payer_id") REFERENCES "users" ("id") ON DELETE SET NULL;

ALTER TABLE "exchanges" ADD FOREIGN KEY ("canceled_by") REFERENCES "users" ("id") ON DELETE SET NULL;

ALTER TABLE "exchanges" ADD FOREIGN KEY ("poster_order_id") REFERENCES "orders" ("id") ON DELETE SET NULL;

ALTER TABLE "exchanges" ADD FOREIGN KEY ("offerer_order_id") REFERENCES "orders" ("id") ON DELETE SET NULL;

ALTER TABLE "exchange_items" ADD FOREIGN KEY ("exchange_id") REFERENCES "exchanges" ("id") ON DELETE CASCADE;

ALTER TABLE "exchange_items" ADD FOREIGN KEY ("gundam_id") REFERENCES "gundams" ("id") ON DELETE SET NULL;

ALTER TABLE "exchange_items" ADD FOREIGN KEY ("owner_id") REFERENCES "users" ("id") ON DELETE SET NULL;

ALTER TABLE "auction_requests" ADD FOREIGN KEY ("gundam_id") REFERENCES "gundams" ("id") ON DELETE SET NULL;

ALTER TABLE "auction_requests" ADD FOREIGN KEY ("seller_id") REFERENCES "users" ("id") ON DELETE CASCADE;

ALTER TABLE "auction_requests" ADD FOREIGN KEY ("rejected_by") REFERENCES "users" ("id") ON DELETE SET NULL;

ALTER TABLE "auction_requests" ADD FOREIGN KEY ("approved_by") REFERENCES "users" ("id") ON DELETE SET NULL;

ALTER TABLE "auctions" ADD FOREIGN KEY ("winning_bid_id") REFERENCES "auction_bids" ("id");

ALTER TABLE "auctions" ADD FOREIGN KEY ("request_id") REFERENCES "auction_requests" ("id") ON DELETE SET NULL;

ALTER TABLE "auctions" ADD FOREIGN KEY ("gundam_id") REFERENCES "gundams" ("id") ON DELETE SET NULL;

ALTER TABLE "auctions" ADD FOREIGN KEY ("seller_id") REFERENCES "users" ("id") ON DELETE SET NULL;

ALTER TABLE "auctions" ADD FOREIGN KEY ("order_id") REFERENCES "orders" ("id") ON DELETE SET NULL;

ALTER TABLE "auctions" ADD FOREIGN KEY ("canceled_by") REFERENCES "users" ("id") ON DELETE SET NULL;

ALTER TABLE "auction_bids" ADD FOREIGN KEY ("auction_id") REFERENCES "auctions" ("id") ON DELETE SET NULL;

ALTER TABLE "auction_bids" ADD FOREIGN KEY ("bidder_id") REFERENCES "users" ("id") ON DELETE SET NULL;

ALTER TABLE "auction_bids" ADD FOREIGN KEY ("participant_id") REFERENCES "auction_participants" ("id") ON DELETE CASCADE;

ALTER TABLE "auction_participants" ADD FOREIGN KEY ("deposit_entry_id") REFERENCES "wallet_entries" ("id");

ALTER TABLE "auction_participants" ADD FOREIGN KEY ("auction_id") REFERENCES "auctions" ("id") ON DELETE CASCADE;

ALTER TABLE "auction_participants" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON DELETE CASCADE;
