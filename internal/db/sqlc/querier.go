...
type Querier interface {
	...
	GetAdminCompletedAuctionsThisWeek(ctx context.Context) (int64, error)
	// Metric 6: Trao đổi hoàn thành thành công tháng này (bảng exchanges)
	GetAdminCompletedExchangesThisMonth(ctx context.Context) (int64, error)
	// Metric 10: Users mới đăng ký tuần này (bảng users)
	GetAdminNewUsersThisWeek(ctx context.Context) (int64, error)
	// Metric 4: Tổng đơn hàng đấu giá tháng này (bảng orders)
	GetAdminTotalAuctionOrdersThisMonth(ctx context.Context) (int64, error)
	// Metric 1: Tổng users hoạt động trên nền tảng (bảng users - không tính admin và moderator)
	GetAdminTotalBusinessUsers(ctx context.Context) (int64, error)
	// Metric 3: Tổng đơn hàng trao đổi tháng này (bảng orders)
	GetAdminTotalExchangeOrdersThisMonth(ctx context.Context) (int64, error)
	// Metric 9: Tổng Gundam đang bán trên nền tảng (bảng gundams)
	GetAdminTotalPublishedGundams(ctx context.Context) (int64, error)
	// Metric 2: Tổng đơn hàng thường tháng này (bảng orders)
	GetAdminTotalRegularOrdersThisMonth(ctx context.Context) (int64, error)
	// Doanh thu thực của nền tảng từ subscription payments
	GetAdminTotalRevenueThisMonth(ctx context.Context) (int64, error)
	// Metric 8: Tổng volume giao dịch ví thành công tuần này (bảng wallet_entries)
	GetAdminTotalWalletVolumeThisWeek(ctx context.Context) (int64, error)
	...
	GetModPendingWithdrawalRequestsCount(ctx context.Context) (int64, error)
	// Metric 3: Tất cả trao đổi được tạo tuần này - VOLUME INDICATOR (bảng exchanges)
	GetModTotalExchangesThisWeek(ctx context.Context) (int64, error)
	// Metric 4: Tất cả đơn hàng được tạo tuần này - VOLUME INDICATOR (bảng orders)
	GetModTotalOrdersThisWeek(ctx context.Context) (int64, error)
	...
	ListWithdrawalRequests(ctx context.Context, status NullWithdrawalRequestStatus) ([]ListWithdrawalRequestsRow, error)
